...
module Blublu
  module Photos
    class Client
      ...
      def addImage(token, request_datetime, sign, imageString)
        send_addImage(token, request_datetime, sign, imageString)
        return recv_addImage()
      end

      def send_addImage(token, request_datetime, sign, imageString)
        send_message('addImage', AddImage_args, :token => token, :request_datetime => request_datetime, :sign => sign, :imageString => imageString)
      end
    ...
    class Processor
      ...
      def process_addImage(seqid, iprot, oprot)
        ...
        result.success = @handler.addImage(args.token, args.request_datetime, args.sign, args.imageString)
